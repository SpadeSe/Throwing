...
public class FirstPersonAIO : MonoBehaviour {
    ...
    public class FPAIO_Editor : Editor{
        ...
        string versionNum = "20.6.2ff (Unity 2017)";
        void OnEnable(){
        ...
        #region Audio/SFX Setup
            ...
            }else{if(GUILayout.Button(adTex1, new GUIStyle(){alignment = TextAnchor.MiddleCenter,fixedWidth = 256 , fixedHeight = 77})){Application.OpenURL("https://assetstore.unity.com/packages/templates/systems/infinigun-universal-fps-firearm-153247");}}
